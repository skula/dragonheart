...
public class PictureLibrary {
	...
	public PictureLibrary(Resources res) {
		...
		this.map.put(R.drawable.dragon_stone_1, BitmapFactory.decodeResource(res, R.drawable.dragon_stone_1));
		this.map.put(R.drawable.dragon_stone_2, BitmapFactory.decodeResource(res, R.drawable.dragon_stone_2));
		this.map.put(R.drawable.dragon_stone_3, BitmapFactory.decodeResource(res, R.drawable.dragon_stone_3));
		this.map.put(R.drawable.dragon_stone_4, BitmapFactory.decodeResource(res, R.drawable.dragon_stone_4));
